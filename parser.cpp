...
void Parser::set_location(string newLocation) {
	this->location = newLocation;
};
string Parser::get_location() {
	return this->location;
};
string Parser::printElementAttributes(DOMNode& node)
{
...
string Parser::printChildTagNames(DOMNode& node, int level, bool last)
{
	string tagTree;
